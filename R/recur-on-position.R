...
#'
#' alma_seq(start, end, on_last_monday_and_sunday)
#'
...
#'   recur_on_position(-1)
#'
#' alma_seq(start, end, on_very_last_monday_or_sunday)
#'
#' wday(alma_seq(start, end, on_very_last_monday_or_sunday), label = TRUE)
#'
#' @export
