...
#'
#' alma_seq("1999-01-01", "1999-06-01", on_monthly)
#'
#' # Adjust to every other month
#' on_every_other_month <- on_monthly %>% recur_on_interval(2)
#'
#' alma_seq("1999-01-01", "1999-06-01", on_every_other_month)
#'
...
#'   recur_on_mday(25:26)
#'
#' alma_seq("1999-01-01", "1999-06-01", on_every_other_month_on_mday_25_or_26)
#'
#' @export
