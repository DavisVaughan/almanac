...
If you have read the introduction vignette, `vignette("almanac")`, then you've seen recurrence rules, schedules, and the functions `alma_search()` and `alma_in()`. Additionally included in {almanac} are a set of functions for adjusting and shifting an existing set of dates, _relative to a schedule_. They will be the topic of this vignette. The three functions are:
