...
An _rbundle_ is a bundle of recurrence schedules. A recurrence schedule, or rschedule, is an overarching term for both rrules and rbundles. The event set of an rbundle is the union of the event sets of every underlying recurrence schedule. It can also contain specialized dates that you want to forcibly include in the event set, called rdates, and ones that you want to forcibly exclude, called exdates.
...
christmas_or_labor_day <- rbundle() %>%
