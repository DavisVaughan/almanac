...
alma_seq("2000-01-01", "2002-01-01", on_first_day_of_quarter)
```
...
alma_seq("2000-01-01", "2002-01-01", on_first_day_of_quarter_march_start)
```
...
alma_seq("2000-01-01", "2002-01-01", on_60th_day_of_q1)
```
...
make_on_nth_day_of_the_quarter <- function(since = "1970-01-01", nth = 1L) {
  ...
  on_nth_day_of_the_quarter <- schedule() %>%
    sch_rrule(on_nth_day_of_q1) %>%
    sch_rrule(on_nth_day_of_q2) %>%
    sch_rrule(on_nth_day_of_q3) %>%
    sch_rrule(on_nth_day_of_q4)
...
alma_seq("2000-01-01", "2002-01-01", on_60th_day_of_the_quarter)
```
...
alma_seq("2000-01-01", "2002-01-01", on_last_day_of_the_quarter)
```
...
alma_seq("2000-01-01", "2002-01-01", on_6th_monday_of_q1)
```
...
alma_seq("2000-01-01", "2002-01-01", on_19th_monday_or_tuesday_of_q1)
```
...
make_on_nth_wday_of_the_quarter <- function(since = "1970-01-01", wday = "Monday", nth = 1L) {
  ...
  on_nth_wday_of_the_quarter <- schedule() %>%
    sch_rrule(on_nth_wday_of_q1) %>%
    sch_rrule(on_nth_wday_of_q2) %>%
    sch_rrule(on_nth_wday_of_q3) %>%
    sch_rrule(on_nth_wday_of_q4)
...
fridays <- alma_seq("2000-01-01", "2002-01-01", on_last_friday_of_the_quarter)
fridays
...
on_last_friday_of_quarter_or_wednesdays <- on_last_friday_of_the_quarter %>%
  sch_rrule(on_wednesdays)

last_friday_or_wednesdays <- alma_seq(
