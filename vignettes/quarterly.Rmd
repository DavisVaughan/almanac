...
make_on_nth_day_of_the_quarter <- function(since = "1970-01-01", nth = 1L) {
  ...
  on_nth_day_of_the_quarter <- rbundle() %>%
    add_cacher(on_nth_day_of_q1) %>%
    add_cacher(on_nth_day_of_q2) %>%
    add_cacher(on_nth_day_of_q3) %>%
    add_cacher(on_nth_day_of_q4)
...
make_on_nth_wday_of_the_quarter <- function(since = "1970-01-01", wday = "Monday", nth = 1L) {
  ...
  on_nth_wday_of_the_quarter <- rbundle() %>%
    add_cacher(on_nth_wday_of_q1) %>%
    add_cacher(on_nth_wday_of_q2) %>%
    add_cacher(on_nth_wday_of_q3) %>%
    add_cacher(on_nth_wday_of_q4)
