...
The secret here is to break the rule into 4 smaller rules, one per quarter, which you can then combine into 1 larger quarterly rbundle. Let's start with a concrete example in Q1. How can we get the 60th day of the quarter?
...
on_last_friday_of_quarter_or_wednesdays <- rbundle() %>%
  add_rschedule(on_wednesdays) %>%
  add_rschedule(on_last_friday_of_the_quarter)
