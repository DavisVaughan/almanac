...
[![Codecov test coverage](https://codecov.io/gh/DavisVaughan/almanac/graph/badge.svg)](https://app.codecov.io/gh/DavisVaughan/almanac) [![R-CMD-check](https://github.com/DavisVaughan/almanac/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/DavisVaughan/almanac/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
First off, it directly embeds the *amazing* JavaScript library [rrule](https://github.com/jkbrzt/rrule) for the core event set calculations.
