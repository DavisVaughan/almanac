...
The above example just scratches the surface of what almanac can do. Practically speaking, you'll probably have multiple holidays and events that you'd like to combine into one bit recurrence object. This is known as a _recurrence bundle_.

This example creates recurrence rules for weekends and Christmas, and bundles them together along with the Thanksgiving rule.
