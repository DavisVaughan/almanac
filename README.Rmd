...
almanac provides tools for working with recurrence rules, the fundamental building blocks used to identify calendar "events", such as weekends or holidays. Constructing recurrence rules looks a little like this:
