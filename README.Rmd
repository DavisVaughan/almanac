...
The above example just scratches the surface of what almanac can do. Practically speaking, you'll probably have multiple holidays and events that you'd like to combine into one big recurrence object. This is known as a _recurrence set_.
...
We can create a stepper that steps over all of the events in the set. If these two holidays were the only ones that your company celebrated, the stepper could be viewed as a way to step forward by a "business day".
