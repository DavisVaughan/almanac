...
almanac implements a _grammar of schedules_, providing the fundamental building blocks to construct schedules that identify "events" such as weekends or holidays. After constructing a schedule, it can be used to:

- Generate dates that fall in the schedule.

- Determine if a date is in the schedule or not.

- Shift a sequence of dates, stepping over dates that fall in the schedule.
