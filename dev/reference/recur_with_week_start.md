...
`recur_with_week_start()` controls the week day that represents the
start of the week. This is important for rules that use
...
- day:
  ...
  `[1, 7]`, with `1 = Monday` and `7 = Sunday`. This is also allowed to
  be a full weekday string like `"Tuesday"`, or an abbreviation like
  `"Tues"`.
